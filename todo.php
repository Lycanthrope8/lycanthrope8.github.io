...
<html>
    <head>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <a href="todo.php"><h1 class="todo">To Do</h1></a>
                </div>
            </div>
        </div>
    ...
    <body>
        ...
        $result = $con->query("SELECT * FROM usertodo WHERE user_id=$user_id AND completed=0 ORDER BY ds,ts ASC");
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <label class="form-label dt" for="date">DATE</label>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input class="form-input" type="time" name="time" required>
                                        <label class="form-label tm" for="time">TIME</label>
                                    </div>
                                </div>
                                <?php 
                                if ($update == true):
    ...
    <?php
        ...
        $result = $con->query("SELECT * FROM usertodo WHERE user_id=$user_id AND completed=1 ORDER BY ds,ts ASC");
        if($result->num_rows > 0){
            ?>
            <div>
                <!--Creating data table-->
